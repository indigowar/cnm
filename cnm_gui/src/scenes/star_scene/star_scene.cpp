...
StarScene::StarScene(Scenes::Switcher* switcher, Scenes::Exiter* exiter)
    : Scene("StarScene", switcher, exiter) {
...
void StarScene::postRender() {}

void StarScene::cleanup() { spdlog::info("TestScene::cleanup()"); }

void StarScene::freeze() { spdlog::info("TestScene::freeze()"); }

void StarScene::invoke() { spdlog::info("TestScene::invoke()"); }

Menu::Menu StarScene::makeMenuBar() {
