#ifndef HPP_CNM_LIB_COMMUNICATION_CHANNEL_IMPL_HPP
#define HPP_CNM_LIB_COMMUNICATION_CHANNEL_IMPL_HPP
...
class channel_impl : public channel<package_t> {
 public:
  explicit channel_impl() = default;
...
class channel_impl<package_t, 1> : public channel<package_t> {
 public:
  explicit channel_impl()
      : mutex_{}, stream_{std::nullopt}, closed_{}, written_{}, read_{} {}

  ~channel_impl() override { close(); }
...
#endif  // HPP_CNM_LIB_COMMUNICATION_CHANNEL_IMPL_HPP
